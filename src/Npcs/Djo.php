...
class Djo extends Npc {
    ...
    public function speak() : string|array {
        if($this->playerHasItem('BionicArms')) {
            ...
            return "Eh... mon petit... tu vois bien, hein, le vieux Djo, il tient plus. Sans mes cachets, 
j'suis foutu... Le souffle me lache, la tete tourne... Il faut que tu m'aides, vite, 
sinon demain... demain je ne suis plus la. Apporte-les-moi, c'est tout ce qui me garde en vie. 
